          ...
          <div className="flex flex-col justify-center py-14 md:py-0 font-playfair ">
            <div className="text-center md:text-left spacy-y-6">
              ...
              <motion.p
                ...
                It ia a long established fact that a reader will be by readable contemt of a page when are the best product.
              </motion.p>
              <motion.div
                ...
                <button className="fles justify-center items-center gap-2 ">
