...
const Banner = ({ image, title, subtitle, link }) => {
  return <div className="container">
    <div className="bg-[#f9f9f9] grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 py-14">
      ...
      {/* Banner text  */}
      <div className="flex flex-col justify-center text-center md:text-left space-y-4 lf:max-w-[500px]">
        <motion.p
        ...
        <motion.div
          ...
          <button className="bg-primary text-white font-semibold py-3 px-6 rounded-md hover: !scale-110 duration-300">Explore More</button>
        </motion.div>
      </div>
    </div>
